...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'files_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['files_vehicules', 'file_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-13 16:09:08',
                'modified' => '2019-09-13 16:09:08',
                'status' => 1
            ],
        ];
        parent::init();
